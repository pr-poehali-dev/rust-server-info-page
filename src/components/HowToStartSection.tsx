        ...
        <Card className="max-w-3xl mx-auto glow-border bg-card/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-3">
              <Button size="lg" className="flex-1 bg-[#1b2838] hover:bg-[#2a475e] text-white shadow-lg shadow-[#66c0f4]/30 hover:shadow-[#66c0f4]/50 border border-[#66c0f4]/50 hover:border-[#66c0f4] transition-all" asChild>
                <a href="https://store.steampowered.com/app/252490/Rust/" target="_blank" rel="noopener noreferrer">
              ...
              <Button size="lg" variant="outline" className="flex-1 border-primary/20 hover:border-primary/50 hover:bg-primary/10 hover:shadow-lg hover:shadow-primary/40 transition-all" asChild>
