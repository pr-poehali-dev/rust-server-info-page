...
const pveServers = [
  {
    ...
    features: ['Скорость сбора x3', 'Еженедельный вайп', 'Максимум 200 игроков', 'Карта 4000'],
    online: '156/200'
  },
  {
    id: '2',
    ...
    features: ['Скорость сбора x5', 'Вайп раз в 2 недели', 'Карта 3500', 'PVE режим'],
    online: '142/150'
  },
  {
    id: '3',
    ...
    features: ['Скорость сбора x8', 'Вайп каждый четверг', 'Карта 3000', 'PVE режим'],
    online: '178/200'
  },
  {
    id: '4',
    ...
    features: ['Скорость сбора x10', 'Готовый лут', 'Разные арены', 'PVE режим'],
    online: '89/100'
  },
  {
    id: '5',
    ...
    features: ['Скорость сбора x20', 'Быстрый прогресс', 'Карта 4500', 'PVE режим'],
    online: '67/100'
  },
  {
    id: '6',
